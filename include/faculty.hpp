...
class faculty : public Person{
    ...
    public:
        ...
        faculty(int id, string name, string email, int phoneNumber, int emergencyContact, int roomNumber, string bloodGroup, string hall, string password) : Person(name, phoneNumber, bloodGroup, emergencyContact){
